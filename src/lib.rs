...
pub fn derive_error_occurence(
    ...
    let data_enum = if let syn::Data::Enum(data_enum) = ast.data {
        ...
        panic!("{proc_macro_name} {ident_stringified} {supports_only_stringified} syn::Data::Enum");
    };
    ...
    let generics = {
        ...
        .fold(String::from(""), |mut acc, gen_param| {
            if let syn::GenericParam::Lifetime(lifetime_deref) = gen_param {
                ...
                panic!("{proc_macro_name} {ident_stringified} {supports_only_stringified} syn::GenericParam::Lifetime");
            }
        });
    ...
    let supported_enum_variant = {
        ...
        let error_message = format!("{proc_macro_name} {ident_stringified} {supports_only_stringified} enums where all variants are {syn_fields}::{named_camel_case} or all variants are {syn_fields}::{unnamed_camel_case}");
        ...
        if let Some(supported_enum_variant) = all_equal {
            ...
            panic!("{proc_macro_name} {ident_stringified} {supports_only_stringified} with enums where all variants are named or unnamed");
        }
    };
    ...
    let crate_traits_error_logs_logic_error_occurence_named_error_occurence_named_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{error_occurence_named_lower_case}::{error_occurence_named_camel_case}");
    ...
    let crate_traits_error_logs_logic_error_occurence_unnamed_error_occurence_unnamed_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{error_occurence_unnamed_lower_case}::{error_occurence_unnamed_camel_case}");
    ...
    let crate_traits_error_logs_logic_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::");
    ...
    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_fields_get_server_port_stringified} {parse_proc_macro2_token_stream_failed_message}"));
    ...
    let crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_stringified = format!("{crate_traits_error_logs_logic_stringified}{to_string_with_config_lower_case}::{to_string_with_config_camel_case}");
    let crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_token_stream = 
    crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_stringified.parse::<proc_macro2::TokenStream>()
    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_stringified} {parse_proc_macro2_token_stream_failed_message}"));
    let to_string_with_config_token_stream = 
    to_string_with_config_lower_case.parse::<proc_macro2::TokenStream>()
    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {to_string_with_config_lower_case} {parse_proc_macro2_token_stream_failed_message}"));
    let token_stream = match supported_enum_variant {
        SuportedEnumVariant::Named => {
                            ...
                            true => {
                                let (code_occurence_type_stringified, code_occurence_lifetime) = {
                                    if let syn::Type::Path(type_path) = &field.ty {
                                        ...
                                        panic!("{proc_macro_name} {ident_stringified} {code_occurence_lower_case} {supports_only_stringified} {syn_type_path_stringified}");
                                    }
                                };
                                    ...
                                    syn::Type::Path(type_path) => {
                                        ...
                                        if path_segment.ident == vec_camel_case {
                                            let vec_element_type = if let syn::PathArguments::AngleBracketed(angle_brackets_generic_arguments) = path_segment.arguments {
                                                        ...
                                                        match type_handle {
                                                            ...
                                                            syn::Type::Reference(type_reference) => {
                                                                let reference_ident = if let syn::Type::Path(type_path) = *type_reference.elem {
                                                                    ...
                                                                    panic!("{proc_macro_name} {ident_stringified} {syn_type_reference} type_reference.elem {supports_only_stringified} {syn_type_path_stringified}");
                                                                };
                                                            ...
                                                            _ => panic!("{proc_macro_name} {ident_stringified} type_handle {supports_only_stringified} {syn_type_path_stringified} and {syn_type_reference}"),
                                                        }
                                                    }
                                                    else {
                                                        panic!("{proc_macro_name} {ident_stringified} angle_brackets_generic_arguments.args[0] {supports_only_stringified} {syn_generic_argument_type_stringified}");
                                                    }
                                                }
                                                else {
                                                ...
                                                panic!("{proc_macro_name} {ident_stringified} path_segment.arguments {supports_only_stringified} syn::PathArguments::AngleBracketed");
                                            };
                                                        ...
                                                        key_generic_argument
                                                    {
                                                        match type_handle {
                                                            ...
                                                            syn::Type::Reference(type_reference) => {
                                                                ...
                                                                if let true = key_reference_ident == str_stringified {
                                                                    HashMapKeyType::Reference {
                                                                        key_reference_ident,
                                                                        key_lifetime_ident: type_reference.lifetime.unwrap_or_else(|| panic!("{proc_macro_name} {ident_stringified} {syn_type_reference} lifetime {is_none_stringified}")).ident
                                                                    }
                                                                }
                                                                else {
                                                        ...
                                                        panic!("{proc_macro_name} {ident_stringified} key_generic_argument {supports_only_stringified} {syn_generic_argument_type_stringified}");
                                                    };
                                                    let hashmap_value_type = if let syn::GenericArgument::Type(type_handle) = value_generic_argument {
                                                        match type_handle {
                                                            ...
                                                            syn::Type::Reference(type_reference) => {
                                                                ...
                                                                if let true = value_reference_ident == str_stringified {
                                                                    HashMapValueType::Reference {
                                                                        value_reference_ident,
                                                                        value_lifetime_ident: type_reference.lifetime.unwrap_or_else(|| panic!("{proc_macro_name} {ident_stringified} {syn_type_reference} lifetime {is_none_stringified}")).ident
                                                                    }
                                                                }
                                                                else {
                                                                    panic!("{proc_macro_name} {ident_stringified} reference_ident != str");
                                                            ...
                                                            _ => panic!("{proc_macro_name} {ident_stringified} type_handle {supports_only_stringified} {syn_type_path_stringified} and syn::Type::Reference"),
                                                        }
                                                    }
                                                    else {
                                                        panic!("{proc_macro_name} {ident_stringified} angle_brackets_generic_arguments.args[0] {supports_only_stringified} {syn_generic_argument_type_stringified}");
            ...
            variants_vec.into_iter().for_each(|(
                ...
                fields_vec.into_iter().enumerate().for_each(|(index, (field_ident, error_or_code_occurence))|{
                    ...
                    match error_or_code_occurence {
                        ErrorOrCodeOccurence::Error { 
                            ...
                            let crate_traits_error_logs_logic_hashmap_display_display_to_string_hashmap_display_display_to_string_stringified = format!("{crate_traits_error_logs_logic_stringified}{hashmap_display_display_to_string_lower_case}::{hashmap_camel_case}{display_camel_case}{display_camel_case}{to_string_camel_case}");
                            ...
                            let (
                                ...
                                NamedAttribute::EoDisplay => {
                                    if let SupportedContainer::Path { path, vec_lifetime: _vec_lifetime } = supported_container {
                                        if path == as_std_collections_hashmap_key_type_stringified  {
                                            panic!("{proc_macro_name} {ident_stringified} {} {as_std_collections_hashmap_key_type_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        else if path == std_str_stringified {
                                            panic!("{proc_macro_name} {ident_stringified} {} {std_str_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        else if path == str_stringified {
                                            panic!("{proc_macro_name} {ident_stringified} {} {str_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        else if path == std_string_string_stringified {
                                            panic!("{proc_macro_name} {ident_stringified} {} {std_string_string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        else if path == string_string_stringified {
                                            panic!("{proc_macro_name} {ident_stringified} {} {string_string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        else if path == string_stringified {
                                            panic!("{proc_macro_name} {ident_stringified} {} {string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_display_stringified), attribute_view(&attribute_display_with_serialize_deserialize_stringified));
                                        }
                                        (
                                            quote::quote! {
                                                {
                                        ...
                                        panic!("{proc_macro_name} {ident_stringified} {} {supports_only_stringified} {supported_container_double_dot_double_dot}Path", attribute_view(&attribute_display_stringified))
                                    }
                                },
                                NamedAttribute::EoDisplayWithSerializeDeserialize => {
                                    match supported_container {
                                        ...
                                        _ => panic!("{proc_macro_name} {ident_stringified} {} only supports {supported_container_double_dot_double_dot}Path and {supported_container_double_dot_double_dot}Reference", attribute_view(&attribute_display_with_serialize_deserialize_stringified)),
                                    }
                                },
                                        ...
                                        quote::quote! {
                                            {
                                                ...
                                                format!(
                                                    #field_name_with_field_value_token_stream,
                                                    {
                                                        use #crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_token_stream;
                                ...
                                NamedAttribute::EoVecDisplay => {
                                    let type_token_stream = if let SupportedContainer::Vec { 
                                        ...
                                        if let VecElementType::Path { element_path, vec_lifetime: _vec_lifetime } = vec_element_type {
                                            if element_path == as_std_collections_hashmap_key_type_stringified  {
                                                panic!("{proc_macro_name} {ident_stringified} {} {as_std_collections_hashmap_key_type_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                            else if element_path == std_str_stringified {
                                                panic!("{proc_macro_name} {ident_stringified} {} {std_str_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                            else if element_path == str_stringified {
                                                panic!("{proc_macro_name} {ident_stringified} {} {str_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                            else if element_path == std_string_string_stringified {
                                                panic!("{proc_macro_name} {ident_stringified} {} {std_string_string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                            else if element_path == string_string_stringified {
                                                panic!("{proc_macro_name} {ident_stringified} {} {string_string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                            else if element_path == string_stringified {
                                                panic!("{proc_macro_name} {ident_stringified} {} {string_stringified} {must_be_used_with_stringified} {}", attribute_view(&attribute_vec_display_stringified), attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                            }
                                    ...
                                    let crate_traits_error_logs_logic_vec_display_into_vec_string_vec_display_into_vec_string_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{vec_display_into_vec_string_lower_case}::{vec_display_into_vec_string_camel_case}");
                                    let crate_traits_error_logs_logic_vec_display_into_vec_string_vec_display_into_vec_string_token_stream = crate_traits_error_logs_logic_vec_display_into_vec_string_vec_display_into_vec_string_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_error_logs_logic_vec_display_into_vec_string_vec_display_into_vec_string_stringified} {parse_proc_macro2_token_stream_failed_message}"));
                                    let vec_display_into_vec_string_token_stream = vec_display_into_vec_string_lower_case
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {vec_display_into_vec_string_lower_case} {parse_proc_macro2_token_stream_failed_message}"));
                                    (
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_lines_space_backslash_lines_space_backslash_token_stream;
                                        ...
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_vec_display_into_vec_string_vec_display_into_vec_string_token_stream;
                                ...
                                NamedAttribute::EoVecDisplayWithSerializeDeserialize => {
                                    let (type_token_stream, serde_borrow_token_stream) = if let SupportedContainer::Vec { 
                                        ...
                                        panic!("{proc_macro_name} {ident_stringified} {} {supports_only_supported_container_stringified}Vec", attribute_view(&attribute_vec_display_with_serialize_deserialize_stringified));
                                    };
                                    (
                                        quote::quote! {
                                            {
                                ...
                                NamedAttribute::EoVecErrorOccurence => {
                                    ...
                                    let crate_traits_error_logs_logic_vec_to_string_with_config_to_string_vec_to_string_with_config_to_string_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{vec_to_string_with_config_to_string_lower_case}::{vec_to_string_with_config_to_string_camel_case}");
                                    let crate_traits_error_logs_logic_vec_to_string_with_config_to_string_vec_to_string_with_config_to_string_token_stream = crate_traits_error_logs_logic_vec_to_string_with_config_to_string_vec_to_string_with_config_to_string_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                ...
                                NamedAttribute::EoHashMapKeyDisplayWithSerializeDeserializeValueDisplay => {
                                    ...
                                    let crate_traits_error_logs_logic_hashmap_display_display_into_hashmap_display_string_hashmap_display_display_into_hashmap_display_string_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{hashmap_display_display_into_hashmap_display_string_lower_case}::{hashmap_display_display_into_hashmap_display_string_camel_case}");
                                    let crate_traits_error_logs_logic_hashmap_display_display_into_hashmap_display_string_hashmap_display_display_into_hashmap_display_string_token_stream = crate_traits_error_logs_logic_hashmap_display_display_into_hashmap_display_string_hashmap_display_display_into_hashmap_display_string_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_error_logs_logic_hashmap_display_display_into_hashmap_display_string_hashmap_display_display_into_hashmap_display_string_stringified} {parse_proc_macro2_token_stream_failed_message}"));
                                    ...
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {hashmap_display_display_into_hashmap_display_string_lower_case} {parse_proc_macro2_token_stream_failed_message}"));
                                    (
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_lines_space_backslash_lines_space_backslash_token_stream;
                                        ...
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_hashmap_display_display_into_hashmap_display_string_hashmap_display_display_into_hashmap_display_string_token_stream;
                                ...
                                NamedAttribute::EoHashMapKeyDisplayWithSerializeDeserializeValueErrorOccurence => {
                                    ...
                                    let (type_token_stream, serde_borrow_token_stream) = if let SupportedContainer::HashMap { 
                                        ...
                                        match (hashmap_key_type, hashmap_value_type) {
                                            ...
                                            ) => panic!("{proc_macro_name} {ident_stringified} {} does not support HashMapKeyType::Path && HashMapValueType::Reference", attribute_view(&attribute_hashmap_key_display_with_serialize_deserialize_value_error_occurence_stringified)),
                                            (
                                                HashMapKeyType::Reference { 
                                                    key_reference_ident, 
                                                    key_lifetime_ident 
                                            ...
                                            ) => panic!("{proc_macro_name} {ident_stringified} {} does not support HashMapKeyType::Reference && HashMapValueType::Reference", attribute_view(&attribute_hashmap_key_display_with_serialize_deserialize_value_error_occurence_stringified)),
                                        }
                                    }
                                    else {
                                    ...
                                    let crate_traits_error_logs_logic_hashmap_display_to_string_with_config_to_string_hashmap_display_to_string_with_config_to_string_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{hashmap_display_to_string_with_config_to_string_lower_case}::{hashmap_display_to_string_with_config_to_string_camel_case}");
                                    let crate_traits_error_logs_logic_hashmap_display_to_string_with_config_to_string_hashmap_display_to_string_with_config_to_string_token_stream = crate_traits_error_logs_logic_hashmap_display_to_string_with_config_to_string_hashmap_display_to_string_with_config_to_string_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                ...
                                NamedAttribute::EoHashMapKeyDisplayForeignTypeValueDisplay => {
                                    let type_token_stream = if let SupportedContainer::HashMap { 
                                        ...
                                        match (hashmap_key_type, hashmap_value_type) {
                                            ...
                                            ) => panic!("{proc_macro_name} {ident_stringified} {} does not support HashMapKeyType::Reference && HashMapValueType::Path", attribute_view(&attribute_hashmap_key_display_foreign_type_value_display_stringified)),
                                            (
                                                HashMapKeyType::Reference { 
                                                    key_reference_ident: _key_reference_ident, 
                                                    key_lifetime_ident: _key_lifetime_ident 
                                    ...
                                    let crate_traits_error_logs_logic_hashmap_display_foreign_type_display_into_hashmap_string_string_hashmap_display_foreign_type_display_into_hashmap_string_string_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{hashmap_display_foreign_type_display_into_hashmap_string_string_lower_case}::{hashmap_display_foreign_type_display_into_hashmap_string_string_camel_case}");
                                    let crate_traits_error_logs_logic_hashmap_display_foreign_type_display_into_hashmap_string_string_hashmap_display_foreign_type_display_into_hashmap_string_string_token_stream = crate_traits_error_logs_logic_hashmap_display_foreign_type_display_into_hashmap_string_string_hashmap_display_foreign_type_display_into_hashmap_string_string_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_error_logs_logic_hashmap_display_foreign_type_display_into_hashmap_string_string_hashmap_display_foreign_type_display_into_hashmap_string_string_stringified} {parse_proc_macro2_token_stream_failed_message}"));
                                    ...
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {hashmap_display_foreign_type_display_into_hashmap_string_string_lower_case} {parse_proc_macro2_token_stream_failed_message}"));
                                    (
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_lines_space_backslash_lines_space_backslash_token_stream;
                                        ...
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_hashmap_display_foreign_type_display_into_hashmap_string_string_hashmap_display_foreign_type_display_into_hashmap_string_string_token_stream;
                                ...
                                NamedAttribute::EoHashMapKeyDisplayForeignTypeValueDisplayForeignTypeWithSerializeDeserialize => {
                                    ...
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_lower_case} {parse_proc_macro2_token_stream_failed_message}"));
                                    let crate_traits_error_logs_logic_hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_hash_map_display_foreign_type_display_foreign_type_into_hash_map_string_display_foreign_type_stringified = format!("{crate_traits_stringified}::{error_logs_logic_stringified}::{hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_lower_case}::{hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_camel_case}");
                                    let crate_traits_error_logs_logic_hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_hash_map_display_foreign_type_display_foreign_type_into_hash_map_string_display_foreign_type_token_stream = crate_traits_error_logs_logic_hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_hash_map_display_foreign_type_display_foreign_type_into_hash_map_string_display_foreign_type_stringified
                                    .parse::<proc_macro2::TokenStream>()
                                    .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {crate_traits_error_logs_logic_hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_hash_map_display_foreign_type_display_foreign_type_into_hash_map_string_display_foreign_type_stringified} {parse_proc_macro2_token_stream_failed_message}"));
                                    (
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_lines_space_backslash_lines_space_backslash_token_stream;
                                        ...
                                        quote::quote! {
                                            {
                                                use #crate_traits_error_logs_logic_hashmap_display_foreign_type_display_foreign_type_into_hashmap_string_display_foreign_type_hash_map_display_foreign_type_display_foreign_type_into_hash_map_string_display_foreign_type_token_stream;
                ...
                .parse::<proc_macro2::TokenStream>()
                .unwrap_or_else(|_| panic!("{proc_macro_name} {ident_stringified} {format_logic_for_source_to_string_with_or_without_config_handle_stringified} {parse_proc_macro2_token_stream_failed_message}"));
        ...
        SuportedEnumVariant::Unnamed => {
            ...
            data_enum.variants.iter().for_each(|variant|{
                ...
                let field_type = if let syn::Fields::Unnamed(fields_unnamed) = &variant.fields {
                    ...
                    panic!("{proc_macro_name} {ident_stringified} {supports_only_stringified} {syn_fields}::{unnamed_camel_case}");
                };
                let (type_token_stream, serde_borrow_token_stream) = if let syn::Type::Path(type_path) = field_type {
                    ...
                    panic!("{proc_macro_name} {ident_stringified} {supports_only_stringified} {syn_type_path_stringified}")
                };
            ...
            quote::quote! {
                impl<
                    ...
                    #config_generic_token_stream
                >
                    #crate_traits_error_logs_logic_to_string_with_config_to_string_with_config_token_stream<
                        #trait_lifetime_token_stream,
                        #config_generic_token_stream
                    > for #ident<#generics>
                where
            ...
            syn::PathArguments::AngleBracketed(angle_bracketed_generic_argument) => {
                angle_bracketed_generic_argument.args.iter().map(|generic_argument|{
                    match generic_argument {
                        ...
                        _ => panic!("{proc_macro_name} {ident_stringified} type_path.path.segments.last() angle_bracketed_generic_argument.args[0] {supports_only_stringified} syn::GenericArgument::Lifetime and {syn_generic_argument_type_stringified}")
                    }
                })
                .collect()
            },
