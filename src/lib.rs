...
pub fn error_occurence(
    ...
    let unnamed_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&unnamed_camel_case);
    ...
    let to_string_without_config_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&to_string_without_config_camel_case);
    ...
    let source_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&source_camel_case);
    let to_string_with_config_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&to_string_with_config_camel_case);
    ...
    let serialize_deserialize_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&proc_macro_helpers::error_occurence::hardcode::SERIALIZE_DESERIALIZE_CAMEL_CASE);
    ...
    let token_stream = match supported_enum_variant {
        proc_macro_helpers::error_occurence::supported_enum_variant::SuportedEnumVariant::Named => {
            ...
            let code_occurence_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&code_occurence_camel_case);
            ...
            let display_foreign_type_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&display_foreign_type_camel_case);
            let display_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&display_camel_case);
                            ...
                            false => {
                                ...
                                let supported_container = match field.ty {
                                    syn::Type::Path(type_path) => {
                                        ...
                                        else if path_segment.ident == proc_macro_helpers::error_occurence::hardcode::HASHMAP_CAMEL_CASE {
                                            let (
                                                hashmap_key_type,
                                                hashmap_value_type
            ...
            let source_to_string_without_config_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&source_to_string_without_config_camel_case);
            ...
            variants_vec.into_iter().for_each(|(
                ...
                fields_vec.into_iter().enumerate().for_each(|(index, (field_ident, error_or_code_occurence))|{
                    ...
                    let to_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&to_string_camel_case);
                    ...
                    match error_or_code_occurence {
                        proc_macro_helpers::error_occurence::error_field_or_code_occurence::ErrorFieldOrCodeOccurence::ErrorField { 
                            ...
                            let lines_space_backslash_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&lines_space_backslash_camel_case);
                            ...
                            let vec_display_to_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_display_to_string_camel_case);
                            ...
                            let string_lower_case = proc_macro_helpers::error_occurence::hardcode::STRING_CAMEL_CASE.to_lowercase();
                            ...
                            let vec_display_foreign_type_to_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_display_foreign_type_to_string_camel_case);
                            ...
                            | {
                                ...
                                else if path == proc_macro_helpers::error_occurence::hardcode::STRING_CAMEL_CASE {
                                    panic!(
                            ...
                            let vec_display_into_vec_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_display_into_vec_string_camel_case);
                            ...
                            let (
                                ...
                                proc_macro_helpers::error_occurence::named_attribute::NamedAttribute::EoVecDisplayForeignType => {
                                    ...
                                    let vec_display_foreign_type_into_vec_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_display_foreign_type_into_vec_string_camel_case);
                                ...
                                proc_macro_helpers::error_occurence::named_attribute::NamedAttribute::EoVecErrorOccurence => {
                                    ...
                                    let vec_to_string_without_config_to_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_to_string_without_config_to_string_camel_case);
                                    ...
                                    let vec_to_string_without_config_to_string_with_serialize_deserialize_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_to_string_without_config_to_string_with_serialize_deserialize_camel_case);
                                    ...
                                    let vec_to_string_with_config_to_string_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&vec_to_string_with_config_to_string_camel_case);
            ...
            let get_code_occurence_lower_case = proc_macro_helpers::naming_conventions::ToLowerSnakeCase::to_lower_snake_case(&get_code_occurence_camel_case);
