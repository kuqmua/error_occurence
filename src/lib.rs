...
pub fn error_occurence(
    ...
    let serialize_deserialize_lower_case = proc_macro_helpers::naming_conventions::ToSnakeCase::to_snake_case(&proc_macro_helpers::error_occurence::hardcode::SERIALIZE_DESERIALIZE_CAMEL_CASE);
